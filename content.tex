...
In the following, we will explain the utilized algorithm formally from the Toan Tran el al. \cite{bayesian_approach} work. As we mentioned the goal is to estimate the parameters of the neural networks using labeled data. The training process is defined by the following optimization problem: 
...
represents the conditional likelihood of label $t_n$, and $p(x_n|\theta)$ is the likelihood of the data $x$. 
